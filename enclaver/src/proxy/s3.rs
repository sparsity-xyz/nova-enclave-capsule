...
const META_ENC_SCHEME: &str = "odyn-enc";
const META_NONCE: &str = "odyn-nonce";
const META_KEY_VERSION: &str = "odyn-key-version";
const META_AAD_MODE: &str = "odyn-aad-mode";
const META_CONTENT_TYPE: &str = "odyn-content-type";
